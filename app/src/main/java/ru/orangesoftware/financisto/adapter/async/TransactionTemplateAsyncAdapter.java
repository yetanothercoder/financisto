...
import ru.orangesoftware.financisto.activity.SelectTemplateSwappableActivity;
...
public class TransactionTemplateAsyncAdapter extends AsyncAdapter<Transaction, TransactionTemplateAsyncAdapter.LocalViewHolder> 
        implements ItemTouchHelperAdapter {
    public static final String TAG = "Financisto." + TransactionTemplateAsyncAdapter.class.getSimpleName();
    ...
    private final SelectTemplateSwappableActivity activity;
    private AtomicLong draggedItemId = new AtomicLong(0);

    public TransactionTemplateAsyncAdapter(int chunkSize,
                                           DatabaseAdapter db,
                                           TransactionTemplateListSource itemSource,
                                           RecyclerView recyclerView,
                                           SelectTemplateSwappableActivity activity) {
